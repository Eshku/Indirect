/**
 * A component that acts as a buffer to store all DAMAGE-related collision events for an entity during a single frame.
 * The DamageSystem reads this buffer to apply damage.
