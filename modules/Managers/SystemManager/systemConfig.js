 ...
 * runs before `PlatformCollisionSystem` to ensure collisions are checked against the new, updated positions.
 *
 * ### Update Frequencies
 ...
 *   called, but they are never added to any update loop. Ideal for purely event-driven systems
...
export const systemSchedule = {
	...
	Initialization: [
		...
		{ name: 'UIInteractionSystem', frequency: 'none' },
	],
	...
	Logic: [
		...
		{ name: 'PlatformCollisionSystem', frequency: 'logic' },
		{ name: 'EventEntityCleanupSystem', frequency: 'logic' }, //currently unused
	],
	...
	Visuals: [
		...
		{ name: 'ViewSystem', frequency: 'visuals' },
	...
	Benchmark: [
		...
		/* { name: 'RWMBenchmarkFriendly', frequency: 'logic' }, */
